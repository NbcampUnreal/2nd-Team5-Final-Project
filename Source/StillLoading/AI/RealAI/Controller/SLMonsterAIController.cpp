#include "SLMonsterAIController.h"
...
void ASLMonsterAIController::OnPossess(APawn* InPawn)
{
...
void ASLMonsterAIController::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

void ASLMonsterAIController::ToggleLockOnWidget(bool bIsLockOnWidget)
{
	LockOnWidgetFront->SetVisibility(bIsLockOnWidget);
	LockOnWidgetBack->SetVisibility(bIsLockOnWidget);
}

ETeamAttitude::Type ASLMonsterAIController::GetTeamAttitudeTowards(const AActor& Other) const
{
