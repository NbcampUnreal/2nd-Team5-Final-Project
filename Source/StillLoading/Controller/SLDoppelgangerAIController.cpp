...
#include "SLDoppelgangerAIController.h"

#include "Perception/AISenseConfig_Sight.h"


ASLDoppelgangerAIController::ASLDoppelgangerAIController()
{
...
ETeamAttitude::Type ASLDoppelgangerAIController::GetTeamAttitudeTowards(const AActor& Other) const
{
...
void ASLDoppelgangerAIController::OnAIPerceptionUpdated(AActor* Actor, FAIStimulus Stimulus)
{
    if (!Actor)
    {
        return;
